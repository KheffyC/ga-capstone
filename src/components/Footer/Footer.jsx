...
const Footer = () => {
  return (
    <footer class="bg-white mt-auto" aria-labelledby="footer-heading">
        <div class="px-3 py-5 mx-auto max-w-7xl lg:py-12 md:px-8 lg:px-15">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-4 xl:col-span-1">
                <Link to="/" class="text-lg font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out transform tracking-relaxed lg:pr-8"> Name of App </Link>
                <p class="w-1/2 mt-2 text-sm text-gray-500">Slogan of App here</p>
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8 xl:mt-0 xl:col-span-2">
                ...
                <div class="w-full mt-8 md:mt-0">
                    <div class="mt-4 lg:justify-end xl:mt-0">
                    <h3 class="text-xs font-semibold tracking-wider text-blue-600 uppercase">Subscribe to our newsletter</h3>
                    <p class="mt-2 text-sm text-gray-500 lg:ml-auto">The latest news, articles, and resources, sent to your inbox weekly.</p>
        ...
        <div class="px-5 py-12 mx-auto bg-gray-50 max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
            ...
            <a href="https://www.facebook.com/kheffy.cervantez" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://www.instagram.com/khefferson/?hl=en" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://mobile.twitter.com/_khefferson" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://github.com/KheffyC" class="text-gray-400 hover:text-gray-500">
