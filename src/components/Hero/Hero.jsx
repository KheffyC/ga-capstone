...
const Hero = ({ recentGames }) => {
  return (
    <>
        <div className="">
            <h1 className="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-white md:text-5xl lg:text-6xl lg:max-w-7xl">General Assembly Gaming Event</h1>
